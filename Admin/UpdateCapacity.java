...
public class UpdateCapacity extends JFrame{
String courseId, capacity;
	public UpdateCapacity(){
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    	setBounds(250, 250, 450, 350);
    	
    	JLabel lbl = new JLabel("Update Capacity");
    	...
    	JLabel lblEnterCid = new JLabel("Enter capacity: ");
	...
	public void Update(){
		try{
			PreparedStatement statement = null;
				...
				String sql = "update capacity set capacity='" +capacity+ "' where course_id ='" + courseId +"'"; 
		         statement = con.prepareStatement(sql);
		         statement.executeUpdate();
		        
		        JOptionPane.showMessageDialog(null," Capacity updated sucessfully");	
			con.close();
			}
