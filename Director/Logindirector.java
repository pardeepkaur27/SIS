...
public class Logindirector extends JFrame{
	...
	JLabel lblAdminLogin = new JLabel("Director Login");
	...
	btnLogin.addActionListener(new ActionListener(){
		...
		try{
			...
			ResultSet rset = statement.executeQuery("SELECT id, password from DirectorDetails");
			int i=0;
			while(rset.next()) {
			...
			if(status==false)
			{
				JOptionPane.showMessageDialog(Logindirector.this,"Invalid login credentials");
				textField.setText("");
