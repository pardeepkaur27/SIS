...
public class FacultyHome extends JFrame{
	...
	JLabel lbl1 = new JLabel(" Faculty Home");
	...
	btnAddCourse.addActionListener(new ActionListener() {
		...
		addGrades obj= new addGrades();
		obj.setVisible(true);
				
		}
	});
	
	JButton btnDropCourse = new JButton("View Courses");
	...
	JButton btnPayFees = new JButton(" Update Grades");
